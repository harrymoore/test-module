define(function(require, exports, module) {
    ...
    var DocumentsList = Ratchet.GadgetRegistry.findClass("documents-list");
    ...
    return Ratchet.GadgetRegistry.register("secondary-pages-list", DocumentsList.extend({
        ...
        doGitanaQuery: function(context, model, searchTerm, query, pagination, callback)
        {
            ...
            if (this.searchState() === null || this.searchState() === undefined || this.searchState() === "children" ){
                query._type = {"$in":["type:secondarypage0","type:genericform","type:secondarypagewithrows0"]};
